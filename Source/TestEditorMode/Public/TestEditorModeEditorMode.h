...
#include "TestEditorModeEditorMode.generated.h"
 ...
 */
UCLASS()
class UTestEditorModeEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_TestEditorModeEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UTestEditorModeEditorMode();
	virtual ~UTestEditorModeEditorMode();
