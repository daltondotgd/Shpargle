...
#include "TestEditorModeInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UTestEditorModeInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UTestEditorModeInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UTestEditorModeInteractiveTool* NewTool = NewObject<UTestEditorModeInteractiveTool>(SceneState.ToolManager);
...
UTestEditorModeInteractiveToolProperties::UTestEditorModeInteractiveToolProperties()
{
...
void UTestEditorModeInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UTestEditorModeInteractiveTool::Setup()
{
	...
	Properties = NewObject<UTestEditorModeInteractiveToolProperties>(this, "Measurement");
...
void UTestEditorModeInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UTestEditorModeInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UTestEditorModeInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UTestEditorModeInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UTestEditorModeInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UTestEditorModeInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UTestEditorModeInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UTestEditorModeInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UTestEditorModeInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
