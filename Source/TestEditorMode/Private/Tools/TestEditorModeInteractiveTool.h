...
#include "TestEditorModeInteractiveTool.generated.h"


/**
 * Builder for UTestEditorModeInteractiveTool
 */
UCLASS()
class TESTEDITORMODE_API UTestEditorModeInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UTestEditorModeInteractiveTool
 */
UCLASS(Transient)
class TESTEDITORMODE_API UTestEditorModeInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UTestEditorModeInteractiveToolProperties();
...
/**
 * UTestEditorModeInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class TESTEDITORMODE_API UTestEditorModeInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UTestEditorModeInteractiveToolProperties> Properties;
